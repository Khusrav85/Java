package Test.RomanArabianCalculator.src;
...
public class RomanArabianCalc {
    ...
    public static void main(String[] args) {
        System.out.println("Введите выражение [2+2] + Enter ");
...
//      Заполняем символьный массив символами строки которую ввел пользователь и по ходу ловим знак операции
        ...
        if (count > 1) {
            throw new IllegalArgumentException("Неверное количество операндов");
        }
        ...
        try {
            ...
            if (number1 > 10 || number2 > 10) {
                throw new IndexOutOfBoundsException("Числа вне диапазона");
            } else {
                result = calculated(number1, number2, operation);
